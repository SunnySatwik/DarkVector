...
export default function Sidebar({
  ...
  return (
    <motion.aside
      ...
      className="glass-sidebar flex flex-col justify-between h-screen shrink-0 relative z-30"
    >
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-y-auto">
        {/* Brand Logo & Name */}
        <div className="p-4 border-b border-white/[0.04] flex items-center justify-between h-16 shrink-0">
        ...
        <div className="p-3 border-b border-white/[0.03] relative shrink-0">
          {isCollapsed ? (
            <div className="flex justify-center">
              <div
                className="p-2 rounded bg-black/40 border border-white/[0.04] text-blue-400"
            ...
            <div className="w-full flex items-center justify-between p-2 bg-black/25 border border-white/[0.04] rounded-lg text-left">
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-blue-500/[0.07] rounded-lg active-navigation-trace z-0"
